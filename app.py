...
page = st.sidebar.selectbox("Pilih Halaman", ["Home", "Perhitungan", "Pembanding"])
...
st.sidebar.markdown("---")
st.sidebar.caption("Aplikasi by: Anda • DATA sumber: file penghitungan manual. :contentReference[oaicite:2]{index=2}")
